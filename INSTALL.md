...
- `fin-0.2.22-arch.tar.gz` (811 KB) - 2025-02-11T23:22:55Z
- `fin-0.2.22-nix.tar.gz` (811 KB) - 2025-02-11T23:22:56Z
- `fin-0.2.22-solus.tar.gz` (811 KB) - 2025-02-11T23:22:55Z
- `fin_0.2.22_amd64.deb` (632 KB) - 2025-02-11T23:22:54Z
...
```sh
sudo eopkg it fin-0.2.22-solus.tar.gz
```
...
```sh
sudo pacman -U fin-0.2.22-arch.tar.gz
```
...
```sh
sudo dpkg -i fin_0.2.22_amd64.deb
```
